...
//    private DriverDescription[] drivers;
    ...
    private void recalcProfit() {
       ...
       passengers = potentialPassengers.stream().sorted(Comparator.comparing(DriverDescription::getReverseProfit).reversed()).collect(Collectors.toList());
...
//    }
    ...
    private class DriverDescription {
        ...
        public int getReverseProfit() { return reverseProfit; } 
    }
