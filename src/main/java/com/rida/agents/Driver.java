...
//    private int[][] graph;
//    private int from, to;
//    private HashSet<DriverDescription> drivers.txt;
...
//        for (DriverDescription dd : drivers.txt) {
...
//
//
//    private void sortAndAssignPassengers() {
...
//            for (DriverDescription driver : drivers.txt) {
